...
def main():
    ...
    document = {
        ...
        "seeds": {
            "note": (
                "Fixed so this file regenerates byte-identically. Private "
        ...
        "vectors": [
            vector(
                ...
                dict(
                    common,
                    domain=BUNDLE_DOMAIN.decode(),
                    spk_id=SPK_ID,
                    spk_pub_hex=spk_pub.hex(),
                    pq_spk_id=PQ_SPK_ID,
